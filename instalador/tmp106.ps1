...
winget install --id SpanishGovernment.Autofirma --silent --accept-package-agreements --accept-source-agreements --scope machine

# 2. Instalación de Google Earth Pro
Write-Host "2/2 Instalando Google Earth Pro..." -ForegroundColor Cyan
winget install --id Google.EarthPro --silent --accept-package-agreements --accept-source-agreements --scope machine
